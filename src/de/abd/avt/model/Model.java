...
//	public static String COLUMN_SINGLE_PRICE = "Preis";
	...
	private static String TECHNIQUE_ROPEWINDER = "Seilaufzug";
	private static String TECHNIQUE_HYDRAULIC = "Hydraulikaufzug";
	
	private static String TYPEOFBUILDING_HOSPITAL = "Krankenhaus";
	private static String TYPEOFBUILDING_DWELLING = "Wohnhaus";
	private static String TYPEOFBUILDING_INDUSTRY = "Industrie";
	...
	public void createModel() {
		...
		ConfigurationDaoController configController = new ConfigurationDaoController();
		configuration = configController.getConfiguration(true);
		...
		techniques = new ArrayList<String>();
		techniques.add(TECHNIQUE_ROPEWINDER);
		techniques.add(TECHNIQUE_HYDRAULIC);
		
		typesOfBuilding = new ArrayList<String>();
		typesOfBuilding.add(TYPEOFBUILDING_INDUSTRY);
		typesOfBuilding.add(TYPEOFBUILDING_HOSPITAL);
		typesOfBuilding.add(TYPEOFBUILDING_DWELLING);
