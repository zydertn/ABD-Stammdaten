...
import de.abd.avt.sort.CountryComparator;


public class CountryDaoController extends DaoController implements IDaoController {
	
	private final static Logger LOGGER = Logger.getLogger(CountryDaoController.class .getName()); 

	public CountryDaoController() {
